...
public class Arithmetic implements ProcedureProvider {
    ...
    public Interpreter registerProcedures(Interpreter it) {
        ...
        it.defineProc(new Procedure("add", (scope, val) -> builtins.add(scope, val), "fst", "snd"));
        it.defineProc(new Procedure("mul", (scope, val) -> builtins.mul(scope, val), "fst", "snd"));
        it.defineProc(new Procedure("sub", (scope, val) -> builtins.sub(scope, val), "fst", "snd"));
        it.defineProc(new Procedure("div", (scope, val) -> builtins.div(scope, val), "fst", "snd"));
        it.defineProc(new Procedure("mod", (scope, val) -> builtins.mod(scope, val), "fst", "snd"));
        it.defineProc(new Procedure("integer", (scope, val) -> builtins.integer(scope, val), "val"));
        it.defineProc(new Procedure("round", (scope, val) -> builtins.round(scope, val), "val"));
